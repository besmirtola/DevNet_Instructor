...
api_url = "https://{0}/restconf/data/ietf-interfaces:interfaces/interface=Loopback1".format(router_ip)
...
print('-------5 (HTTP Method)-------')
print('=> Sending PUT request for Changing interface IP')
# define the interface data

yangConfig = {
  "ietf-interfaces:interface": {
    "name": "Loopback1",
    "description": "New RESTCONF loopback",
